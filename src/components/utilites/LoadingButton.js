...
const LoadingButton = ({ isLoading, isSuccess }) => {
    ...
    return (
        <button type="submit" className={`rounded-2xl bg-background h-12 w-96 border-4 border-blue-here hover:border-background hover:bg-opacity-40 hover:text-black ${isLoading ? 'relative' : ''}`}>
            {isLoading && (
